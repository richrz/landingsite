...
const visionItems = [
  { name: 'AI-Driven Insights', path: '/vision/ai' },
  { name: 'Unified Platform', path: '/vision/platform' },
  { name: 'Real-time Analytics', path: '/vision/analytics' },
  { name: 'Seamless Integration', path: '/vision/integration' },
  { name: 'Predictive Modeling', path: '/vision/predictive' },
];

const CARROT_WIDTH = 16; // 8px left + 8px right

const VisionFlyout: React.FC = () => {
